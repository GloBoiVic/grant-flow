  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-background px-4 py-8">
      <div className="mb-6 flex w-full max-w-md items-center justify-between">
         <div><p className="text-label text-muted-foreground">GrantFlow</p><h1 className="mt-1 text-title text-foreground">Create your organization</h1></div>
        <UserButton />
      </div>
       <p className="max-w-md text-center text-sm leading-6 text-muted-foreground">Create your organization to start using GrantFlow.</p>
